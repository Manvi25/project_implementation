...
df_list = ['order_details_df', 'clientPreferencesData_df', 'cancellationData_df', 'itemMetadata_df', 'marketplace_df', 'storepreferenceData_df', 'commercialConditiondata_df', 'invoiceData_df', 'openTextField_df', 'sellers_df', 'payment_data_df', 'totals_df', 'client_profile_df', 'marketing_data_df', 'rates_and_benefits_data_df', 'shipping_data_df', 'items_df', 'bundle_items_df']
